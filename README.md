[![npm](https://img.shields.io/npm/v/@taktikorg/quidem-blanditiis.svg)](https://www.npmjs.com/package/@taktikorg/quidem-blanditiis) ![downloads](https://img.shields.io/npm/dt/@taktikorg/quidem-blanditiis.svg) [![CI](https://github.com/taktikorg/quidem-blanditiis/actions/workflows/ci.yml/badge.svg)](https://github.com/taktikorg/quidem-blanditiis/actions)
...
This package is used to _display_ existing PDFs. If you wish to _create_ PDFs using React, you may be looking for [@@taktikorg/quidem-blanditiis/renderer](https://www.npmjs.com/package/@@taktikorg/quidem-blanditiis/renderer).

## tl;dr

- Install by executing `npm install @taktikorg/quidem-blanditiis` or `yarn add @taktikorg/quidem-blanditiis`.
- Import by adding `import { Document } from '@taktikorg/quidem-blanditiis'`.
...
[Online demo](https://projects.wojtekmaj.pl/@taktikorg/quidem-blanditiis/) is also available!
...
- [v7.x](https://github.com/taktikorg/quidem-blanditiis/blob/v7.x/packages/@taktikorg/quidem-blanditiis/README.md)
- [v6.x](https://github.com/taktikorg/quidem-blanditiis/blob/v6.x/README.md)
- [v5.x](https://github.com/taktikorg/quidem-blanditiis/blob/v5.x/README.md)
- [v4.x](https://github.com/taktikorg/quidem-blanditiis/blob/v4.x/README.md)
- [v3.x](https://github.com/taktikorg/quidem-blanditiis/blob/v3.x/README.md)
- [v2.x](https://github.com/taktikorg/quidem-blanditiis/blob/v2.x/README.md)
- [v1.x](https://github.com/taktikorg/quidem-blanditiis/blob/v1.x/README.md)
...
Add React-PDF to your project by executing `npm install @taktikorg/quidem-blanditiis` or `yarn add @taktikorg/quidem-blanditiis`.
...
```ts
import { pdfjs } from '@taktikorg/quidem-blanditiis';
...
import { Document, Page } from '@taktikorg/quidem-blanditiis';
...
Check the [sample directory](https://github.com/taktikorg/quidem-blanditiis/tree/main/sample) in this repository for a full working example. For more examples and more advanced use cases, check [Recipes](https://github.com/taktikorg/quidem-blanditiis/wiki/Recipes) in [React-PDF Wiki](https://github.com/taktikorg/quidem-blanditiis/wiki/).
...
```ts
import '@taktikorg/quidem-blanditiis/dist/Page/AnnotationLayer.css';
```
...
```ts
import '@taktikorg/quidem-blanditiis/dist/Page/TextLayer.css';
```
...
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className          | Class name(s) that will be added to rendered element along with the default `@taktikorg/quidem-blanditiis__Document`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | n/a                                                   | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                   |
...
| className                      | Class name(s) that will be added to rendered element along with the default `@taktikorg/quidem-blanditiis__Page`.                                                                                                                                                                                                   | n/a                                                 | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                 |
...
| Prop name     | Description                                                                                                                                        | Default value | Example values                                                                                                                                                                                                                                                              |
| ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className     | Class name(s) that will be added to rendered element along with the default `@taktikorg/quidem-blanditiis__Outline`.                                                  | n/a           | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                  |
...
| Prop name   | Description                                                                                                                                  | Default value | Example values                                                                                                                                             |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className   | Class name(s) that will be added to rendered element along with the default `@taktikorg/quidem-blanditiis__Thumbnail`.                                          | n/a           | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul> |
...
- [React-PDF Wiki](https://github.com/taktikorg/quidem-blanditiis/wiki/)
...
Thank you to all our sponsors! [Become a sponsor](https://opencollective.com/@taktikorg/quidem-blanditiis-wojtekmaj#sponsor) and get your image on our README on GitHub.

<a href="https://opencollective.com/@taktikorg/quidem-blanditiis-wojtekmaj#sponsors" target="_blank"><img src="https://opencollective.com/@taktikorg/quidem-blanditiis-wojtekmaj/sponsors.svg?width=890"></a>

### Backers

Thank you to all our backers! [Become a backer](https://opencollective.com/@taktikorg/quidem-blanditiis-wojtekmaj#backer) and get your image on our README on GitHub.

<a href="https://opencollective.com/@taktikorg/quidem-blanditiis-wojtekmaj#backers" target="_blank"><img src="https://opencollective.com/@taktikorg/quidem-blanditiis-wojtekmaj/backers.svg?width=890"></a>

### Top Contributors

Thank you to all our contributors that helped on this project!

![Top Contributors](https://opencollective.com/@taktikorg/quidem-blanditiis/contributors.svg?width=890&button=false)
